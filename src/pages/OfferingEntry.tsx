...
const SUNDAY_FIELDS: {
  ...
  { key: 'monthly_thanksgiving', label: 'Thanksgiving', remittance: 0.70 },
  { key: 'sunday_love_offering', label: 'Sunday Love Offering', remittance: 0.20 },
  { key: 'gospel_fund', label: 'Gospel Fund', remittance: 0.25 },
  { key: 'first_fruit', label: 'First Fruit', remittance: 0.90 },
  { key: 'mission', label: 'Mission', remittance: 1.00 },
  { key: 'sunday_school', label: 'Sunday School', remittance: 0.50 },
  { key: 'children_offering', label: 'Children Offering', remittance: 0.35 },
  { key: 'house_fellowship', label: 'House Fellowship', remittance: 0.40 },
