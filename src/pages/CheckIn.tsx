...
import { getMemberByPhone, getTodaySession, checkInMember, getAttendance } from '../lib/db'
...
export default function CheckIn() {
  ...
  function handlePrintQR() {
    ...
    printWindow.document.write(`
      <html>
        <head>
          <title>Grace Assembly - Check-In QR Code</title>
          <style>
            body {
              display: flex;
        ...
        <>
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6 mb-6">
            <p className="text-xs text-gray-400 mb-3 text-center">
              Manual check-in — enter member phone number
            </p>
              ...
              <div className="mt-4 bg-gray-800 rounded-xl p-4">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-xs">{foundMember.role} · {foundMember.sex}</p>
                  </div>
                </div>
                <div className="flex gap-3">
                  <button
            ...
            {notFound && (
              <div className="mt-4 bg-red-500/10 border border-red-500/20 rounded-xl p-4 text-center">
                ...
                <p className="text-red-400 font-semibold text-sm">Member not found</p>
          ...
          {/* QR Code */}
          <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6 text-center" ref={qrRef}>
